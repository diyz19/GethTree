...
#正常版本
geth-tree --identity "MyEth" --rpc --rpcport "8549" --rpccorsdomain "*" --datadir gethdata --port "30309" --nodiscover --rpcapi "eth,net,personal,web3,miner" --networkid "w1" init genesisgtrie.json
##无log
...
##有log
geth-tree --identity "MyEth" --rpc --rpcport "8549" --rpccorsdomain "*" --datadir gethdata --port "30309" --nodiscover --rpcapi "eth,net,personal,web3,miner" --networkid "w1" --syncmode "branch" --allow-insecure-unlock --dev.period 1 --preload "../test_file/w1_setbranch.js" console >> ../result/log_w1
